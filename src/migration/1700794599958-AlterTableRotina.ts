...
export class AlterTableRotina1700794599958 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "rotina" ADD "dias" integer array NOT NULL DEFAULT '{}'`);
        await queryRunner.query(`ALTER TABLE "rotina" ADD "concluido" boolean NOT NULL DEFAULT false`);
    }
